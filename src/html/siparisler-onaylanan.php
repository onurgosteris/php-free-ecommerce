...
<body>
    		...
    		<div class="row">
    			<div class="col-12">
    				<div class="card">
                          ...
                          if (isset($_POST['siparisguncelle'])) {
                            ...
                            if ($siparisguncelle['status']){
                                ...
                                <div class="alert alert-success" role="alert">
                                    ...
                                    <?php 
                                    if ($siparis_cek['affiliate_id']!=0) {
                                       echo $ortakcek['ad_soyad']." isimli ortağın bakiye ve referansı düşürüldü. Yeni bakiyesi:".$_POST['bakiye']; // bakiye kısmına $ortak_bakiye yazdırırsak db den eski değeri alır bu yüzden postu yazdırıyoruz tekrar db den yeni değeri çekmemize gerek yok.
                                    }
                                    ?>
                                </div>
                                <?php
                      ...
                      <tbody> 
                         <?php 
                         $siparissor = $db->wread2("siparisler","siparis_durum",1);
 ...
 <div class="custom-control custom-radio">
     ...
     class="custom-control-input" 
     <?php if ($sipariscek['siparis_durum']==3) {
         echo "checked";
     } ?>>
