    								...
    								<div class="card">
    									<div class="card-body">
    										...
    										<div class="collapse" id="menuekle">
                                                ...
                                                <h3 align="center" class="card-title">ANA MENÜLER</h3>
                                                <div class="table-responsive">
                                                    <table id="zero_config2" class="table table-striped table-bordered no-wrap">
                                                        ...
                                                        <tbody> 
                                                            <?php 
                                                            $menucek=$db->wread2("menu","menu_ust",0,[
                                                            ...
                                                            while ($satir=$menucek->fetch(PDO::FETCH_ASSOC)) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center">
                                                                        ...
                                                                        <td align="center"><a  data-toggle="collapse" href="#duzenle<?php echo $satir['menu_id']; ?>"
                                                                            aria-expanded="false" aria-controls="duzenle<?php echo $satir['menu_id'];?>">
                                                                            <button type="button" class="btn btn-outline-success" data-toggle="modal"
                                                                            data-target="#duzenle<?php echo $satir['menu_id']; ?>"><i class="fas fa-cogs"></i></button>
                                                                        </a>
                                                                        <div id="duzenle<?php echo $satir['menu_id']; ?>" class="modal fade" tabindex="-1" role="dialog"
                                                                            aria-hidden="true">
                                                                ...
                                                                <h3 align="center" class="card-title">ALT MENÜLER</h3>
                                                                <div class="table-responsive">
