...
$from="onurg@altingrami.net";
$Sender="onurg@altingrami.net";
$gonderici="Onur Gösteriş";
$host="mail.altingrami.net";
$pass="2a2eaonurx";
...
$mail->AddAddress("onurgosteris@hotmail.com"); // Mail gönderilecek adresleri ekliyoruz.
