			...
			<div class="row">
				...
				<div class="p-t-40">
					...
					<p class="stext-107 cl6 txt-center"> 
						&copy;<script>document.write(new Date().getFullYear());</script> Telif Hakları ve Tüm Hakları Gizlidir | Bu e-Ticaret Scripti <i class="aria-hidden="true"></i><a href="https://www.onurgosteris.com.tr/" target="_blank">Onur Gösteriş</a> tarafından oluşturulmuştur. 
