...
// $kullanici_id=1;
// $kullanici_adsoyad="ad soyad";
// $kullanici_adsoyadp="soyad";
...
$donus_url = "https://".$_SERVER['SERVER_NAME']."/sonuc.php?siparis_no=$siparis_no&durum=basarili";
...
$request->setCallbackUrl($donus_url);
